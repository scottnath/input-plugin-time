/**
 * Validation for Time Input Plugin
 *
 ...
 * @param {String|Bool} input.all.time - value of input time
 ...
 * @param {Object} [settings.all.time] - settings of input time {Object}
 *
...
module.exports = function timeValidation(input, settings) {
